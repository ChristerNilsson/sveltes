...
var app = (function () {
    ...
    // (36:1) {#each cards as card}
    function create_each_block(ctx) {
    	let div;
    	let t0_value = (/*card*/ ctx[4].state == 1 ? /*card*/ ctx[4].value : ".") + "";
    	let t0;
    	let t1;
    	let div_class_value;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", div_class_value = "card " + ("state" + /*card*/ ctx[4].state) + " svelte-1gu7dnj");
    			add_location(div, file, 36, 2, 784);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*cards*/ 1 && t0_value !== (t0_value = (/*card*/ ctx[4].state == 1 ? /*card*/ ctx[4].value : ".") + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*cards*/ 1 && div_class_value !== (div_class_value = "card " + ("state" + /*card*/ ctx[4].state) + " svelte-1gu7dnj")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:1) {#each cards as card}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 34, 0, 722);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	let cards = lodash_shuffle(lodash_range(12).map(i => ({ state: 0, value: i % 6 })));
    	const visible = [];
