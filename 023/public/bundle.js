...
var app = (function () {
    ...
    /* src\SVG.svelte generated by Svelte v3.12.1 */

    const file = "src\\SVG.svelte";

    function create_fragment(ctx) {
    	var svg, g2, rect, path0, path1, path2, path3, g1, path4, path5, path6, g0, path7, path8, path9, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "class", "svelte-nnqv87");
    			add_location(svg, file, 16, 0, 257);

    			dispose = [
    				listen_dev(svg, "click", ctx.click),
    				listen_dev(svg, "mousemove", ctx.mousemove)
    			];
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { viewBox = "3100 -382 100 100", x, y, width = 100, height = 100, click = () => {} } = $$props;
    	let { mousemove = () => {} } = $$props;

    	const writable_props = ['viewBox', 'x', 'y', 'width', 'height', 'click', 'mousemove'];
    	...
    	$$self.$set = $$props => {
    		...
    		if ('mousemove' in $$props) $$invalidate('mousemove', mousemove = $$props.mousemove);
    	};

    	$$self.$capture_state = () => {
    		return { viewBox, x, y, width, height, click, mousemove };
    	};
    ...
    class SVG extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, ["viewBox", "x", "y", "width", "height", "click", "mousemove"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "SVG", options, id: create_fragment.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.x === undefined && !('x' in props)) {
    			console.warn("<SVG> was created without expected prop 'x'");
    		}
    		if (ctx.y === undefined && !('y' in props)) {
    			console.warn("<SVG> was created without expected prop 'y'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	var svg2, rect, line0, line1, current;

    	var svg0 = new SVG({
    		props: {
    		x: "0",
    		y: "0",
    		viewBox: "3104 -384 320 320",
    		width: 320*N,
    		height: 320*N,
    		click: ctx.click,
    		mousemove: ctx.mousemove
    	},
    		$$inline: true
    	});
    	...
    	var svg1 = new SVG({
    		...
    		x: "900",
    		y: "0",
    		viewBox: "" + (3054+25+ctx.x/N) + " " + (-434+25+ctx.y/N) + " 50 50",
    		width: N*100,
    		height: N*100
    	},
    		$$inline: true
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "x", "0");
    			attr_dev(rect, "y", "0");
    			attr_dev(rect, "width", "1200");
    			attr_dev(rect, "height", "1000");
    			set_style(rect, "fill", "gray");
    			add_location(rect, file$1, 14, 1, 279);
    			attr_dev(line0, "x1", 900);
    			attr_dev(line0, "y1", N*50);
    			attr_dev(line0, "x2", 900+N*100);
    			attr_dev(line0, "y2", N*50);
    			set_style(line0, "stroke", "black");
    			set_style(line0, "stroke-width", "1");
    			add_location(line0, file$1, 18, 1, 535);
    			attr_dev(line1, "x1", 900+N*50);
    			attr_dev(line1, "y1", 0);
    			attr_dev(line1, "x2", 900+N*50);
    			attr_dev(line1, "y2", N*100);
    			set_style(line1, "stroke", "black");
    			set_style(line1, "stroke-width", "1");
    			add_location(line1, file$1, 19, 1, 634);
    			attr_dev(svg2, "width", "1200");
    			attr_dev(svg2, "height", "1000");
    			add_location(svg2, file$1, 13, 0, 248);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(svg0, svg2, null);
    			mount_component(svg1, svg2, null);
    		...
    		p: function update(changed, ctx) {
    			var svg1_changes = {};
    			if (changed.x || changed.y) svg1_changes.viewBox = "" + (3054+25+ctx.x/N) + " " + (-434+25+ctx.y/N) + " 50 50";
    ...
    const click = () => points.push({x,y});
    const mousemove = (event) => $$invalidate('x', [x,y] = [event.x,event.y], x, $$invalidate('y', y));
