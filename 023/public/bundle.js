...
var app = (function () {
    ...
    /* src/SVG.svelte generated by Svelte v3.16.7 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file, 20, 3, 409);
    			...
    			add_location(path0, file, 29, 2, 731);
    			...
    			add_location(path1, file, 37, 2, 1546);
    			...
    			add_location(path2, file, 45, 2, 2357);
    			...
    			add_location(path3, file, 51, 2, 3015);
    			...
    			add_location(path4, file, 58, 3, 3825);
    			...
    			add_location(path5, file, 59, 3, 42524);
    			...
    			add_location(path6, file, 60, 3, 47483);
    			...
    			add_location(path8, file, 65, 2, 120261);
    			...
    			add_location(path9, file, 74, 2, 121088);
    			attr_dev(g2, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(g2, "id", "g6392");
    			add_location(g2, file, 19, 1, 354);
    			attr_dev(svg, "viewBox", /*viewBox*/ ctx[0]);
    			attr_dev(svg, "x", /*x*/ ctx[1]);
    			attr_dev(svg, "y", /*y*/ ctx[2]);
    			attr_dev(svg, "width", /*width*/ ctx[3]);
    			attr_dev(svg, "height", /*height*/ ctx[4]);
    			attr_dev(svg, "class", "svelte-1onelnp");
    			add_location(svg, file, 16, 0, 241);

    			dispose = [
    				listen_dev(svg, "click", /*click*/ ctx[5], false, false, false),
    				listen_dev(svg, "mousemove", /*mousemove*/ ctx[6], false, false, false)
    			];
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { viewBox = "3100 -382 100 100" } = $$props;
    	let { x } = $$props;
    	let { y } = $$props;
    	let { width = 100 } = $$props;
    	...
    	$$self.$set = $$props => {
    		...
    		if ("mousemove" in $$props) $$invalidate(6, mousemove = $$props.mousemove);
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const svg1 = new SVG({
    			props: {
    				x: "900",
    				y: "0",
    				viewBox: "" + (3054 + 25 + /*x*/ ctx[0] / N + " " + (-434 + 25 + /*y*/ ctx[1] / N) + " 50 50"),
    				width: N * 100,
    				height: N * 100
    			},
    			$$inline: true
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect, file$1, 14, 1, 265);
    			attr_dev(line0, "x1", line0_x__value = 900);
    			attr_dev(line0, "y1", line0_y__value = N * 50);
    			attr_dev(line0, "x2", line0_x__value_1 = 900 + N * 100);
    			attr_dev(line0, "y2", line0_y__value_1 = N * 50);
    			set_style(line0, "stroke", "black");
    			set_style(line0, "stroke-width", "1");
    			add_location(line0, file$1, 18, 1, 517);
    			attr_dev(line1, "x1", line1_x__value = 900 + N * 50);
    			attr_dev(line1, "y1", line1_y__value = 0);
    			attr_dev(line1, "x2", line1_x__value_1 = 900 + N * 50);
    			attr_dev(line1, "y2", line1_y__value_1 = N * 100);
    			set_style(line1, "stroke", "black");
    			set_style(line1, "stroke-width", "1");
    			add_location(line1, file$1, 19, 1, 615);
    			attr_dev(svg2, "width", "1200");
    			attr_dev(svg2, "height", "1000");
    			add_location(svg2, file$1, 13, 0, 235);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			const svg1_changes = {};
    			if (dirty & /*x, y*/ 3) svg1_changes.viewBox = "" + (3054 + 25 + /*x*/ ctx[0] / N + " " + (-434 + 25 + /*y*/ ctx[1] / N) + " 50 50");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const mousemove = event => $$invalidate(0, [x, y] = [event.x, event.y], x, $$invalidate(1, y));
