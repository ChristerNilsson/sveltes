...
var app = (function () {
    ...
    /* src/Card.svelte generated by Svelte v3.16.7 */
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "x", rect_x_value = /*x*/ ctx[2] - SIZE / 2);
    			attr_dev(rect, "y", rect_y_value = /*y*/ ctx[3] - SIZE / 2);
    			attr_dev(rect, "width", rect_width_value = SIZE - 1);
    			attr_dev(rect, "height", rect_height_value = SIZE - 1);
    			set_style(rect, "fill", /*card*/ ctx[0].state == 0 ? "red" : "green");
    			add_location(rect, file, 22, 1, 360);
    			dispose = listen_dev(rect, "click", /*click_handler*/ ctx[5], false, false, false);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*card*/ ctx[0].marker > 0) return create_if_block_1;
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(image, "class", "middle svelte-a3b19k");
    			attr_dev(image, "preserveAspectRatio", "");
    			attr_dev(image, "x", image_x_value = /*x*/ ctx[2] - SIZE / 2);
    			attr_dev(image, "y", image_y_value = /*y*/ ctx[3] - SIZE / 2);
    			attr_dev(image, "width", image_width_value = SIZE - 1);
    			attr_dev(image, "height", image_height_value = SIZE - 1);
    			attr_dev(image, "href", image_href_value = /*card*/ ctx[0].url);
    			add_location(image, file, 40, 2, 681);
    			dispose = listen_dev(image, "click", /*click_handler_2*/ ctx[7], false, false, false);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, image, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*card*/ 1 && image_href_value !== (image_href_value = /*card*/ ctx[0].url)) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(text_1, "class", "middle svelte-a3b19k");
    			attr_dev(text_1, "x", /*x*/ ctx[2]);
    			attr_dev(text_1, "y", /*y*/ ctx[3]);
    			add_location(text_1, file, 34, 2, 578);
    			dispose = listen_dev(text_1, "click", /*click_handler_1*/ ctx[6], false, false, false);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*card*/ 1 && t_value !== (t_value = /*card*/ ctx[0].text + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	let if_block0 = /*card*/ ctx[0].state != 2 && create_if_block_2(ctx);
    	let if_block1 = /*card*/ ctx[0].state == 1 && create_if_block(ctx);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [card, click, x, y, index, click_handler, click_handler_1, click_handler_2];
    }

    class Card extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { index: 4, card: 0, click: 1 });
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*cards*/ 1) card_changes.card = /*card*/ ctx[6];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(62:1) {#each cards as card, index}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$1, 60, 0, 7686);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click = card => {
    		...
    		$$invalidate(0, cards);
    		visible.push(card);
    		if (done >= 2 * N - 2 && visible.length == 2) $$invalidate(0, cards = []);
    	};
