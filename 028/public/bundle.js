...
var app = (function () {
    ...
    /* src/P5.svelte generated by Svelte v3.16.7 */
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<P5> was created with unknown prop '${key}'`);
    	});
    ...
    class P5 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*sketch*/ ctx[0] === undefined && !("sketch" in props)) {
    			console.warn("<P5> was created without expected prop 'sketch'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 36, 0, 557);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self) {
    	const sketch = function (p5) {
    		...
    		p5.one = () => {
    			p5.push();
    			p5.arc(-60, 0, 200, 200, 90, 270);
    			p5.arc(60, 0, 200, 200, -90, 60);
    			p5.line(-50, -100, 50, -100);
    			p5.line(-120, 100, 0, 100);
    			p5.pop();
    		};
